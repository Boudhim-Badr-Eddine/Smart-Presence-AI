...
export default function RoleNavBar() {
  ...
  return (
    <nav className="sticky top-0 z-50 border-b border-white/10 bg-white/5 backdrop-blur-xl dark:border-white/10 dark:bg-white/5 light:border-gray-200 light:bg-white" role="navigation" aria-label="Main navigation">
      <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3">
        {/* Logo */}
        <div className="flex items-center gap-2">
          <div className="flex h-8 w-8 items-center justify-center rounded-lg bg-amber-600">
            <span className="text-sm font-bold text-white" aria-hidden="true">SP</span>
          </div>
          <span className="hidden text-sm font-semibold text-white sm:inline dark:text-white light:text-gray-900">Smart Presence AI</span>
        </div>
      ...
      {/* Mobile Menu */}
      {mobileMenuOpen && (
        <div className="border-t border-zinc-800 dark:border-zinc-800 light:border-gray-200 md:hidden" role="menu">
