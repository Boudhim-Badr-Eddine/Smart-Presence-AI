      ...
      <div className="rounded-xl border border-white/10 bg-white/5 overflow-hidden dark:border-white/10 dark:bg-white/5 light:border-gray-200 light:bg-white">
        <table className="w-full">
          <thead className="bg-white/5 dark:bg-white/5 light:bg-gray-50">
            <tr>
              <th className="px-4 py-3 text-left text-xs font-medium text-zinc-400 dark:text-zinc-400 light:text-gray-600">
                Date
              </th>
              <th className="px-4 py-3 text-left text-xs font-medium text-zinc-400 dark:text-zinc-400 light:text-gray-600">
                Matière
          ...
          <tbody>
            {filtered.map((record) => (
              ...
              >
                <td className="px-4 py-3 text-sm text-white dark:text-white light:text-gray-900">
                  {record.date}
                </td>
                <td className="px-4 py-3 text-sm text-white dark:text-white light:text-gray-900">
                  {record.subject}
                ...
                <td className="px-4 py-3">
                  <span
                    className={`inline-flex items-center gap-1 px-2 py-1 rounded text-xs font-medium ${getStatusColor(record.status)}`}
                  >
