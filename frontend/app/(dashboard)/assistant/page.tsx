          ...
          <div className="relative flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="space-y-2">
              ...
              <p className="max-w-2xl text-sm text-white/70">
                Posez vos questions sur les présences, les sessions, ou les notifications.
                L&apos;assistant se base sur vos données et garde le contexte de la conversation.
              </p>
              <div className="flex flex-wrap gap-3 text-xs text-amber-100/80">
                <span className="rounded-full bg-amber-500/20 px-3 py-1">
                  Dashboards admin / formateur / étudiant
                </span>
                <span className="rounded-full bg-white/10 px-3 py-1">
                  Suivi absences et alertes
                </span>
                <span className="rounded-full bg-white/10 px-3 py-1">
                  Prompts rapides prêts à l&apos;emploi
                </span>
              </div>
            </div>
            <div className="flex items-center gap-3 rounded-xl border border-white/10 bg-white/5 px-4 py-3 text-sm text-white/80 shadow-lg">
              ...
              <div>
                ...
                <p className="text-xs text-white/70">
                  Vous pouvez fermer cette page, la conversation reste enregistrée.
                </p>
              </div>
            </div>
          </div>
