  ...
  const cards = [
    {
      ...
      value: stats?.this_week_sessions ?? 0,
      ...
      <div className="mx-auto max-w-7xl p-6">
          ...
          steps={[
            {
              ...
              content: 'Vos cours et sessions à venir en temps réel.',
              placement: 'right',
            },
            {
              target: "a[href='/trainer/mark-attendance']",
              title: 'Pointer les présences',
              content: "Marquez rapidement l'assiduité via QR, biométrie ou PIN.",
              placement: 'bottom',
            },
            {
              target: "a[href='/trainer/sessions']",
              title: 'Toutes les sessions',
              content: "Visualisez l'ensemble de votre calendrier.",
              placement: 'right',
            },
          ]}
          autoStart
        ...
        <div className="mb-6">
          ...
          <p className="text-sm text-zinc-400 dark:text-zinc-400 light:text-gray-600">
            Vue d'ensemble de vos sessions et statistiques.
          </p>
        </div>
